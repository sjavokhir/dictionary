...
fun DictFilledButton(
    ...
    Button(
        ...
        modifier = if (small) {
            modifier
                .fillMaxWidth()
                .heightIn(min = DictButtonDefaults.SmallButtonHeight)
        } else {
            modifier
                .fillMaxWidth()
                .heightIn(min = DictButtonDefaults.NormalButtonHeight)
        },
        enabled = enabled,
        colors = DictButtonDefaults.filledButtonColors(
            containerColor = containerColor,
            contentColor = contentColor
        ),
        shape = shape,
        contentPadding = DictButtonDefaults.buttonContentPadding(
            small = small,
...
fun DictOutlinedButton(
    ...
    OutlinedButton(
        ...
        enabled = enabled,
        colors = DictButtonDefaults.textButtonColors(
            containerColor = containerColor,
            contentColor = contentColor
        ),
        shape = shape,
...
private fun RowScope.ButtonContent(
    ...
    if (leadingIcon != null) {
        Box(
            modifier = Modifier.sizeIn(maxHeight = DictButtonDefaults.ButtonIconSize)
        ) {
            DictIcon(
                painter = leadingIcon,
                color = contentColor
        ...
        modifier = Modifier
            ...
            .padding(
                start = if (leadingIcon != null) {
                    DictButtonDefaults.ButtonContentSpacing
                } else {
                    0.dp
                },
...
private object DictButtonDefaults {
